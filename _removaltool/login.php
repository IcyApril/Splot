...
$sql= 'SELECT * FROM `dmcausers` WHERE user="'.$username.'" AND password="'.$hashedpassword.'"';
...
<title><?=$sitename?> Log-in</title> 
    ...
    <link rel="shortcut icon" href="../_src/php/assets/ico/favicon.ico">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="../_src/php/assets/ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="../_src/php/assets/ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="../_src/php/assets/ico/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" href="../_src/php/assets/ico/apple-touch-icon-57-precomposed.png">
</head>
<body>
<div class="container">
...
<input class="btn btn-success" type="submit" value="Submit" />
          ...
          <h1>Log-in…</h1>
          <p>Please login...</p>
<p><a data-toggle="modal" href="#form" class="btn btn-primary btn-large">Show login form.</a> <a href="../_src/php/index.php" class="btn btn-large">Leave and return to homepage.</a></p>
    <!-- Le javascript
    ================================================== -->
